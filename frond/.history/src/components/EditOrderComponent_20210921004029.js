                ...
                <div className="row">
                    <div className="table-responsive ">
                        <table className="table table-striped table-hover table-bordered text-center">
                            ...
                            <tbody>
                                {
                                    Object.keys(currentOrder.itemsAmmount).map(
                                        (item, index) =>
                                        <tr key = {item}>
                                            <td>{index+1}</td>
                                            <td>{currentOrder.itemsProduct[item].name }</td>
                                            <td>{Object.values(currentOrder.itemsAmmount)[index]}</td>
                                            <td>{currentOrder.itemsProduct[item].unit_price }</td>
                                            <td>{currentOrder.itemsProduct[item].unit_price*Object.values(currentOrder.itemsAmmount)[index]}</td>
                                            <td>
                                                <div className="d-flex justify-content-center">
                                                    <div>
                                                        <button onClick={() => this.editProduct(item,Object.values(currentOrder.itemsAmmount)[index])} type="button" className="btn btn-link">Edit</button>
                                                    </div>
                                                    <div>
