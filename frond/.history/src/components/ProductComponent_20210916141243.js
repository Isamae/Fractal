...
class ProductComponent extends React.Component{
    ...
    render(){
        return (
            <div  class="container ">
                <div class="d-flex flex-row"><h1> Product List </h1></div>
                <div class="d-flex flex-row-reverse  margin-bottom:1rem">
                        <button type="button" class="btn btn-primary padding-bottom: 5 !important">Create Product</button>
                </div>
                <div class="row">
