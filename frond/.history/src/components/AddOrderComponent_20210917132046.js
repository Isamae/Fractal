...
class AddOrder extends Component {
    ...
    addConsumer(){
        ...
        Routes.createOrder(data)
            .then(response => {
                this.setState({
                    consumer._id: response.data._id,
                });
                    ...
                    >
                        ...
                        <Modal.Title>Add Consumer</Modal.Title>
                            ...
                            <Modal.Body>
                                ...
                                <button  class="btn btn-success mt-4">Add Consumer</button>
                            </Modal.Body>
                
                        <Modal.Footer>

                            <button onClick={this.addConsumer} class="btn btn-success mt-4">Close</button>
