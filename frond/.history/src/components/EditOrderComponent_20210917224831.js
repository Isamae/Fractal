...
class EditProduct extends Component {
    constructor(props) {
        super(props);
        this.addProduct = this.onChangeName.bind(this);
        this.getProduct = this.onChangeCategory.bind(this);
        this.editProduct = this.onChangePrice.bind(this);
        this.deleteProduct = this.onChangeStatus.bind(this);
        this.saveOrder = this.getProductItem.bind(this);
        this.rejectOrder = this.updateProduct.bind(this);
