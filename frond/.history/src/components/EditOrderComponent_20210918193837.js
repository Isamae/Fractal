                    ...
                    >
                        ...
                        <Modal.Title>Add Product</Modal.Title>
                            ...
                            <Modal.Body>
                                ...
                                {editItem ? (<button onClick={this.setProduct} class="btn btn-success mt-4">Edit Product</button>):(<button onClick={this.addProduct} class="btn btn-success mt-4">Add Product</button>)
