...
class EditProduct extends Component {
    ...
    addProduct(){
        /*const items = this.state.currentOrder.items;
        items.push(this.state.productSelected);*/
        const itemsProduct = {this.state.productSelected => this.state.amount }
        this.setState(function(prevState) {
            return {
                currentOrder: {
                    ...prevState.currentProduct,
                    items: [...this.currentOrder.items, this.state.productSelected]
                }
            };
        }).then(
            this.updateOrder
