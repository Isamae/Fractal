...
class AddProduct extends Component {
    ...
    render() {
        return (
            <div  class="container ">
                <div class="d-flex flex-row"><h1>New Product</h1></div>

                <div class="submit-form">
                    {this.state.submitted ? (
                    <div>
                        <h4>You submitted successfully!</h4>
                        <button class="btn btn-success" onClick={this.newProduct}>
                            Add
                        </button>
                    </div>
                    ) : (
                    <div>
                        ...
                        <button onClick={this.saveProduct} class="btn btn-success">
                            Submit
                        </button>
                    </div>
                    )}
